...
<html lang="es">
    ...
    <body>
        <div class="col-md-12 col-md-offset-0">
            <form method="POST" action="">
                <div class="d-flex justify-content-between">
                    ...
                    <div class="my-2">
                        <button class="btn btn-success" onclick="exportTablaToExcel('<?php echo $FileName ?>', '#IdResumenCxX')">Exportar Excel</button>
                    </div>
                </div>
                <table class="table table-bordered table-striped" id="IdResumenCxC">
                    ...
                    ?>
                            ...
                            <tr align="center">
                                ...
                                <td style="color: blue;">
                                    <?php 
                                        $scad = "('DetalleCxC.php', '" . $sCod . "', '" . $sName . "' )";
                                        $cad = '<span><a onclick="DetalleCxCM' . $scad . '" id="'. $sCod .'" data-toggle="modal" data-target=".resumen-xl">Detalle</a></span>';
                                        echo '<span><a onclick="DetalleCxCM' . $scad . '" id="'. $sCod .'" data-toggle="modal" data-target="#x0">' . $cad . '</a></span>' ; 
                                    ?>
                                </td>  
                            </tr>
            ...
            <div class="modal fade" id="CxCModal" tabindex="-1" role="dialog" aria-labelledby="ZZxx" aria-hidden="true">
                <div class="modal-dialog modal-xl" >
                    <div class="modal-content"> 
                        <div class="modal-header text-center">
                            <h3>Relación Facturas a Cobrar</h3>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                        <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        <div class="modal-body ml-0 pl-0"><p  id="contenido2" class="ml-0 pl-0"></p></div>
                        <div class="modal-body ml-0 pl-0"><p  id="contenidoF" class="ml-0 pl-0"></p></div>
        ...
        <script type="text/javascript">
            ...
            function DetalleCxCM(Pag, Cod, Razon) {
                
                // $("#contenido2").load(pag,{ClienteID: Cod, NameC: Razon});
                var ModalPedido = new bootstrap.Modal(CxCModal, {}).show();
